...
function CachedFirstRender(tags, searchIn, textGenerator, imageFunction, options){
 ...
 let staleQuery = "https://raw.githubusercontent.com/pietervdvn/pietervdvn.github.io/master/Quickmaps/cache/"+searchIn+"/"+encodeURIComponent(filter).replace(/~/g, '%3D')+".json"
