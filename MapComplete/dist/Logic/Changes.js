...
function (_super) {
  ...
  OsmNode.prototype.ChangesetXML = function (changesetId) {
    ...
    var change = '        <node id="' + this.id + '" changeset="' + changesetId + '" version="' + this.version + '" lat="' + this.lat + '" lon="' + this.lon + '">\n' + tags + '        </node>\n';
    return change;
  };
...
function (_super) {
  ...
  OsmWay.prototype.ChangesetXML = function (changesetId) {
    ...
    var change = '    <way id="' + this.id + '" changeset="' + changesetId + '" version="' + this.version + '">\n' + nds + tags + '        </way>\n';
    return change;
  };
...
function (_super) {
  ...
  OsmRelation.prototype.ChangesetXML = function (changesetId) {
    ...
    var change = '    <relation id="' + this.id + '" changeset="' + changesetId + '" version="' + this.version + '">\n' + members + tags + '        </relation>\n';
    console.log(change);
    return change;
  };
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"UI/UIEventSource.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  QuestionUI.prototype.RenderRadioText = function () {
    ...
    var ansId = "q" + this._qid + "-answer" + c;
    radios += "<input type='radio' name='q" + this._qid + "' id='" + ansId + "' value='" + c + "' />" + "<label for='" + ansId + "'>Andere: <input type='text' id='q-" + this._qid + "-textbox' onclick='checkRadioButton(\"" + ansId + "\")'/></label>" + "<br />";
    return radios;
  };
  ...
  QuestionUI.prototype.InnerRender = function () {
    ...
    var skip = "<input class='skip-button' type='button' onclick='" + embeddedScriptSkip + "' value='Ik ben het niet zeker' />";
...
},{"../UI/UIElement":"UI/UIElement.ts"}],"Logic/Changes.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function Changes(login, allElements, centerMessage) {
    this._pendingChanges = [];
    this.pendingChangesES = new UIEventSource_1.UIEventSource(this._pendingChanges);
    this.login = login;
  ...
  Changes.prototype.addChange = function (elementId, key, value) {
    ...
    if (!this.login.userDetails.data.loggedIn) {
      console.log("hi");
      this.centerMessage.setData("<p>Bedankt voor je antwoord!</p>" + "<p>Gelieve <span class='activate-osm-authentication'>in te loggen op OpenStreetMap</span> om dit op te slaan.</p>" + "<p>Nog geen account? <a href=\'https://www.openstreetmap.org/user/new\' target=\'_blank\'>Registreer hier</a></p>");
      var self_1 = this;
      this.login.userDetails.addCallback(function () {
        if (self_1.login.userDetails.data.loggedIn) {
          self_1.centerMessage.setData("");
        }
      });
      return;
    }
  ...
  Changes.prototype.uploadAll = function (optionalContinuation) {
    ...
    function DownloadAndContinue(continuation) {
    ...
    DownloadAndContinue(function () {
      console.log("Continuing", knownElements); // Here, inside the continuation, we know that all 'neededIds' are loaded
      ...
      self.login.UploadChangeset("Updaten van metadata met Mapcomplete", function (csId) {
        var changes = "";
        ...
        changes = "<osmChange version='0.6' generator='Mapcomplete 0.0.0'>" + "<modify>" + changes + "</modify>" + "</osmChange>";
        return changes;
...
},{"./OsmObject":"Logic/OsmObject.ts","../UI/UIEventSource":"UI/UIEventSource.ts","./Question":"Logic/Question.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","Logic/Changes.ts"], null)
//# sourceMappingURL=/Logic/Changes.js.map