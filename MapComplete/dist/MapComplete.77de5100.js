...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/jshashes/hashes.js":[function(require,module,exports) {
...
},{"ohauth":"node_modules/ohauth/index.js","resolve-url":"node_modules/resolve-url/resolve-url.js","store":"node_modules/store/dist/store.legacy.js","xtend":"node_modules/xtend/immutable.js"}],"LoginElement.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  LoginElement.prototype.UpdateUserBadge = function () {
    this.auth.xhr({
      method: 'GET',
      ...
      var userName = userInfo.getAttribute('display_name');
      var img = userInfo.getElementsByTagName("img")[0].getAttribute("href");
      console.log(img);
  ...
  LoginElement.prototype.OpenChangeset = function (comment, continuation) {
    console.log("Opened");
    this.auth.xhr({
      method: 'PUT',
  ...
  LoginElement.prototype.AddChange = function (changesetId) {
    console.log("uploading");
    var changes = "<osmChange version='0.6' generator='Mapcomplete 0.0.0'>" + "<modify>" + "<node id='7564216431' version='1'>" + "<tag k='fixme' v='remove me after testing'/>" + "</node>" + "</modify>" + "</osmChange>";
    this.auth.xhr({
      method: 'POST',
  ...
  LoginElement.prototype.CloseChangeset = function (changesetId) {
    console.log("closing");
    this.auth.xhr({
      method: 'PUT',
...
exports.LoginElement = LoginElement;
},{"osm-auth":"node_modules/osm-auth/index.js"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var LoginElement_1 = require("./LoginElement");

var login = new LoginElement_1.LoginElement();
login.OpenChangeset("Testing Mapcomplete 0.0.0", function (csId) {
...
*/
},{"./LoginElement":"LoginElement.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/MapComplete.77de5100.js.map