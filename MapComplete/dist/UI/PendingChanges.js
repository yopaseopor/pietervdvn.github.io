...
function (_super) {
  ...
  function PendingChanges(changes, countdown) {
    ...
    countdown.addCallback(function () {
      var percentage = Math.max(0, 100 * countdown.data / 20000);
  ...
  PendingChanges.prototype.InnerRender = function () {
    return "<div id='pending-bar' style='width:100%; margin-left:0%'></div>" + "<div id='pending-text'></div>";
  };

  PendingChanges.prototype.InnerUpdate = function (htmlElement) {};
