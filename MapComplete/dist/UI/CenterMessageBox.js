...
function () {
  ...
  Helpers.registerActivateOsmAUthenticationClass = function (osmConnection) {
...
},{}],"UI/CenterMessageBox.ts":[function(require,module,exports) {
"use strict";
...
var CenterMessageBox =
/** @class */
function (_super) {
  __extends(CenterMessageBox, _super);

  function CenterMessageBox(centermessage, osmConnection, location, layers) {
    var _this = _super.call(this, centermessage) || this;

    _this.zoomInMore = new UIEventSource_1.UIEventSource(true);
    _this.centermessage = centermessage;
    _this.location = location;
    _this.layers = layers;
    _this.osmConnection = osmConnection;
    var minZoomForAll = 0;
    ...
    _this.ListenTo(_this.zoomInMore);
  ...
  CenterMessageBox.prototype.InnerUpdate = function (htmlElement) {
    ...
    if (this.centermessage.data != "") {
      ...
      Helpers_1.Helpers.registerActivateOsmAUthenticationClass(this.osmConnection);
      return;
    }
...
},{"./UIElement":"UI/UIElement.ts","./UIEventSource":"UI/UIEventSource.ts","../Helpers":"Helpers.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/CenterMessageBox.ts"], null)
//# sourceMappingURL=/UI/CenterMessageBox.js.map