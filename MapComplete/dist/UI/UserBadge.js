...
function (_super) {
  ...
  UserBadge.prototype.InnerRender = function () {
    ...
    return "<img id='profile-pic' src='" + user.img + "'/> " + "<div id='usertext'>" + "<div id='username'>" + "<a href='https://www.openstreetmap.org/user/" + user.name + "' target='_blank'>" + user.name + "</a></div> <br />" + "<div id='csCount'> " + "   <a href='https://www.openstreetmap.org/user/" + user.name + "/history' target='_blank'><img class='star' src='./assets/star.svg'/>" + user.csCount + "</div></a>" + "</div>";
  };
