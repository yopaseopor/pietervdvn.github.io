...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"Question.ts":[function(require,module,exports) {
"use strict";
...
function () {
   ...
   * @param requiredTags
   */
  function Question(question, severity, tagKey, answers, requiredTags) {
  ...
  Question.prototype.Applicable = function (tags) {
    ...
    for (var _i = 0, _a = this._requiredTags; _i < _a.length; _i++) {
      var neededTag = _a[_i];
      var k = neededTag.k;
  ...
  Question.prototype.CreateHtml = function (tags) {
    ...
    for (var _i = 0, _a = this._answers; _i < _a.length; _i++) {
      var answer = _a[_i];
      var human = answer.a;
      var ansId = "q0+answer" + c;
      c++;
      radios += "<input type='radio' name='q0' id='" + ansId + "' value='" + answer.v + "' />" + "<label for='" + ansId + "'>" + human + "</label>" + "<br />";
    }

    return this._question + "<br/>  " + radios;
  };
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","Question.ts"], null)
