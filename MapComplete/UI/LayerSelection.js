...
},{"./Translation":"UI/i18n/Translation.ts","../UIElement":"UI/UIElement.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Input/CheckBox.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function CheckBox(showEnabled, showDisabled, data) {
    ...
    _this._data = data instanceof UIEventSource_1.UIEventSource ? data : new UIEventSource_1.UIEventSource(data !== null && data !== void 0 ? data : false);

    _this.ListenTo(_this._data);

    _this._showEnabled = showEnabled;
    _this._showDisabled = showDisabled;
    var self = _this;
...
},{"../UIElement":"UI/UIElement.ts","../UIEventSource":"UI/UIEventSource.ts","../../UI/i18n/Translations":"UI/i18n/Translations.ts"}],"UI/LayerSelection.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(LayerSelection, _super);

  function LayerSelection(layers) {
    var _this = _super.call(this, undefined) || this;
    ...
    for (var _i = 0, layers_1 = layers; _i < layers_1.length; _i++) {
      ...
      var checkbox = "<svg width=\"26\" height=\"18\" viewBox=\"0 0 26 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n            <path d=\"M3 7.28571L10.8261 15L23 3\" stroke=\"#003B8B\" stroke-width=\"4\" stroke-linejoin=\"round\"/>\n            </svg>";
      var icon = "<img >";
      ...
      var name = layer.layerDef.name;

      _this._checkboxes.push(new CheckBox_1.CheckBox(new Combine_1.default([checkbox, icon, name]), new Combine_1.default(["<svg width=\"26\" height=\"18\" viewBox=\"0 0 26 18\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n            <path d=\"M3 7.28571L10.8261 15L23 3\" stroke=\"#ffffff\" stroke-width=\"4\" stroke-linejoin=\"round\"/>\n            </svg>", icon, layer.layerDef.name]), layer.isDisplayed));
    }

    return _this;
  }

  LayerSelection.prototype.InnerRender = function () {
    var html = "";

    for (var _i = 0, _a = this._checkboxes; _i < _a.length; _i++) {
      var checkBox = _a[_i];
      var checkBoxHTML = checkBox.Render();
      var checkBoxListItem = "<li>" + checkBoxHTML + "</li>";
...
},{"./UIElement":"UI/UIElement.ts","./Input/CheckBox":"UI/Input/CheckBox.ts","./Base/Combine":"UI/Base/Combine.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/LayerSelection.ts"], null)
//# sourceMappingURL=/UI/LayerSelection.js.map