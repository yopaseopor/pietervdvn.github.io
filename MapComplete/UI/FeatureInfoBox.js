...
},{}],"UI/TagMapping.ts":[function(require,module,exports) {
"use strict";
...
exports.TagMapping = exports.TagMappingOptions = void 0;

var UIElement_1 = require("./UIElement");

var TagMappingOptions =
/** @class */
function () {
  function TagMappingOptions(options) {
  ...
  return TagMappingOptions;
}();

exports.TagMappingOptions = TagMappingOptions;

var TagMapping =
/** @class */
function (_super) {
  __extends(TagMapping, _super);

  function TagMapping(options, tags) {
  ...
  TagMapping.prototype.IsEmpty = function () {
    var o = this.options;
    return this.tags[o.key] === undefined && o.missing === undefined;
  };

  TagMapping.prototype.InnerRender = function () {
    var o = this.options;
    var v = this.tags[o.key];
  ...
  TagMapping.prototype.InnerUpdate = function (htmlElement) {};

  return TagMapping;
}(UIElement_1.UIElement);

exports.TagMapping = TagMapping;
},{"./UIElement":"UI/UIElement.ts"}],"Logic/Question.ts":[function(require,module,exports) {
...
},{"../UI/UIElement":"UI/UIElement.ts"}],"UI/QuestionPicker.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  QuestionPicker.prototype.InnerRender = function () {
    ...
    return "<div class='infobox-questions'>" + highestQ.CreateHtml(this.source).Render() + "</div>";
  };

  QuestionPicker.prototype.InnerUpdate = function (htmlElement) {};

  QuestionPicker.prototype.Activate = function () {};
...
function (_super) {
  ...
  function DropDownUI(label, values) {
    var _this = _super.call(this, undefined) || this;

    _this._label = label;
    _this._values = values;
    _this.selectedElement = new UIEventSource_1.UIEventSource(values[0].value);
    return _this;
  }
  ...
  DropDownUI.prototype.InnerUpdate = function (htmlElement) {
...
function (_super) {
  ...
  function ImageUploadFlow(userInfo, uploadOptions) {
    var _this = _super.call(this, undefined) || this;
...
/** @class */
function () {
  function OsmImageUploadHandler(tags, userdetails, changeHandler, slideShow) {
  ...
  OsmImageUploadHandler.prototype.getUI = function () {
    var self = this;
    return new ImageUploadFlow_1.ImageUploadFlow(this._userdetails, function (license) {
...
},{"../UIElement":"UI/UIElement.ts","../../Logic/ImageSearcher":"Logic/ImageSearcher.ts","../SlideShow":"UI/SlideShow.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Img.ts":[function(require,module,exports) {
"use strict";
...
exports.Img = Img;
},{}],"Layers/CommonTagMappings.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CommonTagMappings = void 0;

var TagMapping_1 = require("../UI/TagMapping");

var Img_1 = require("../UI/Img");

var CommonTagMappings =
/** @class */
function () {
  function CommonTagMappings() {}

  CommonTagMappings.access = new TagMapping_1.TagMappingOptions({
    key: "access",
    mapping: {
  ...
  CommonTagMappings.operator = new TagMapping_1.TagMappingOptions({
    key: "operator",
  ...
  CommonTagMappings.osmLink = new TagMapping_1.TagMappingOptions({
    key: "id",
    mapping: {
      "node/-1": ""
    },
    template: "<span class='osmlink'><a href='https://osm.org/{id}' target='_blank'>" + Img_1.Img.osmAbstractLogo + "</a></span>"
  });
  CommonTagMappings.wikipediaLink = new TagMapping_1.TagMappingOptions({
    key: "wikipedia",
    missing: "",
    freeform: function freeform(value) {
      var link = ""; // @ts-ignore
      ...
      return "<span class='wikipedialink'>" + "<a href='" + link + "' target='_blank'>" + "<img width='64px' src='./assets/wikipedia.svg' alt='wikipedia'" + "</a></span>";
    }
  });
  return CommonTagMappings;
}();

exports.CommonTagMappings = CommonTagMappings;
},{"../UI/TagMapping":"UI/TagMapping.ts","../UI/Img":"UI/Img.ts"}],"UI/Base/VerticalCombine.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/FeatureInfoBox.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function FeatureInfoBox(tagsES, elementsToShow, questions, changes, userDetails) {
    ...
    _this._questions = new QuestionPicker_1.QuestionPicker(_this._changes.asQuestions(questions), _this._tagsES);
    var infoboxes = [];

    for (var _i = 0, elementsToShow_1 = elementsToShow; _i < elementsToShow_1.length; _i++) {
      var uiElement = elementsToShow_1[_i];

      if (uiElement instanceof Question_1.QuestionDefinition) {
        var questionDef = uiElement;
        var question = new Question_1.Question(_this._changes, questionDef);
        infoboxes.push(question.CreateHtml(_this._tagsES));
      } else if (uiElement instanceof TagMapping_1.TagMappingOptions) {
        var tagMappingOpt = uiElement;
        infoboxes.push(new TagMapping_1.TagMapping(tagMappingOpt, _this._tagsES));
      } else {
        var ui = uiElement;
        infoboxes.push(ui);
      }
    ...
    _this._title = infoboxes.shift();
    _this._infoElements = infoboxes;
    _this._osmLink = new TagMapping_1.TagMapping(CommonTagMappings_1.CommonTagMappings.osmLink, _this._tagsES);
    _this._wikipedialink = new TagMapping_1.TagMapping(CommonTagMappings_1.CommonTagMappings.wikipediaLink, _this._tagsES);
    _this._pictureUploader = new OsmImageUploadHandler_1.OsmImageUploadHandler(tagsES, userDetails, changes, _this._imageElement.slideshow).getUI();
    return _this;
  }
...
},{"./UIElement":"UI/UIElement.ts","./TagMapping":"UI/TagMapping.ts","../Logic/Question":"Logic/Question.ts","./QuestionPicker":"UI/QuestionPicker.ts","../Logic/OsmImageUploadHandler":"Logic/OsmImageUploadHandler.ts","./Image/ImageCarousel":"UI/Image/ImageCarousel.ts","../Layers/CommonTagMappings":"Layers/CommonTagMappings.ts","./Base/VerticalCombine":"UI/Base/VerticalCombine.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
