...
},{"process":"node_modules/process/browser.js"}],"Logic/Imgur.ts":[function(require,module,exports) {
"use strict";
...
exports.Imgur = Imgur;
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"UI/Base/DropDownUI.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(DropDownUI, _super);

  function DropDownUI(label, values, selectedElement) {
  ...
  DropDownUI.prototype.InnerRender = function () {
    var options = "";
    ...
    return "<form>" + "<label for='dropdown-" + this.id + "'>" + this._label + "</label>" + "<select name='dropdown-" + this.id + "' id='dropdown-" + this.id + "'>" + options + "</select>" + "</form>";
  };

  DropDownUI.prototype.InnerUpdate = function () {
    var self = this;
    var e = document.getElementById("dropdown-" + this.id); // @ts-ignore
...
},{"../UIEventSource":"UI/UIEventSource.ts","../UIElement":"UI/UIElement.ts"}],"UI/Base/VariableUIElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/ImageUploadFlow.ts":[function(require,module,exports) {
"use strict";
...
var DropDownUI_1 = require("./Base/DropDownUI");
...
function (_super) {
  ...
  function ImageUploadFlow(userInfo, preferedLicense, uploadOptions) {
    ...
    var licensePicker = new DropDownUI_1.DropDownUI("Jouw foto wordt gepubliceerd ", [{
      value: "CC0",
      shown: "in het publiek domein"
    }, {
      value: "CC-BY-SA 4.0",
      shown: "onder een CC-BY-SA-licentie"
    }, {
      value: "CC-BY 4.0",
      shown: "onder een CC-BY-licentie"
    }], preferedLicense);
    _this._licensePicker = licensePicker;
    _this._selectedLicence = licensePicker.selectedElement;
    var licenseExplanations = {
      "CC-BY-SA 4.0": "<b>Creative Commonse met naamsvermelding en gelijk delen</b><br/>" + "Je foto mag door iedereen gratis gebruikt worden, als ze je naam vermelden én ze afgeleide werken met deze licentie en attributie delen.",
      "CC-BY 4.0": "<b>Creative Commonse met naamsvermelding</b> <br/>" + "Je foto mag door iedereen gratis gebruikt worden, als ze je naam vermelden",
...
},{"./UIElement":"UI/UIElement.ts","./UIEventSource":"UI/UIEventSource.ts","jquery":"node_modules/jquery/dist/jquery.js","../Logic/Imgur":"Logic/Imgur.ts","./Base/DropDownUI":"UI/Base/DropDownUI.ts","./Base/VariableUIElement":"UI/Base/VariableUIElement.ts"}],"Logic/OsmImageUploadHandler.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  OsmImageUploadHandler.prototype.generateOptions = function (license) {
    ...
    var description = ["author:" + this._userdetails.data.name, "license:" + license, "wikidata:" + tags.wikidata, "osmid:" + tags.id, "name:" + tags.name].join("\n");
...
},{"../UI/ImageUploadFlow":"UI/ImageUploadFlow.ts"}],"Logic/Wikimedia.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  WikimediaImage.prototype.InnerRender = function () {
    ...
    var wikimediaLink = "<a href='https://commons.wikimedia.org/wiki/" + this._imageLocation + "' target='_blank'>" + "<img class='wikimedia-link' src='./assets/wikimedia-commons-white.svg' alt='Wikimedia Commons Logo'/>" + "</a> ";
...
},{"../UIEventSource":"UI/UIEventSource.ts","../UIElement":"UI/UIElement.ts","../../Logic/Wikimedia":"Logic/Wikimedia.ts"}],"UI/Image/SimpleImageElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"Logic/ImageSearcher.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function ImageSearcher(tags) {
    ...
    _this._wdItem.addCallback(function () {
      ...
      var wikidataId = self._wdItem.data; // @ts-ignore
    ...
    _this._commons.addCallback(function () {
      var commons = self._commons.data; // @ts-ignore
  ...
  ImageSearcher.prototype.Activate = function () {
    ...
    this._tags.addCallback(function () {
  ...
  ImageSearcher.prototype.LoadImages = function () {
    ...
    var image0 = this._tags.data["image:0"];
    ...
    var imageIndex = 1;
    var imagei = this._tags.data["image:" + imageIndex];
  ...
  ImageSearcher.CreateImageElement = function (url) {
    var urlSource = new UIEventSource_1.UIEventSource(url); // @ts-ignore

    if (url.startsWith("File:")) {
      return new WikimediaImage_1.WikimediaImage(urlSource.data);
    } else {
      return new SimpleImageElement_1.SimpleImageElement(urlSource);
    }
  };
...
function (_super) {
  ...
  function ImageCarousel(tags) {
    ...
    _this.searcher = new ImageSearcher_1.ImageSearcher(tags);

    var uiElements = _this.searcher.map(function (imageURLS) {
      var uiElements = [];

      for (var _i = 0, imageURLS_1 = imageURLS; _i < imageURLS_1.length; _i++) {
        var url = imageURLS_1[_i];
        uiElements.push(ImageSearcher_1.ImageSearcher.CreateImageElement(url));
      }

      return uiElements;
    });

    _this.slideshow = new SlideShow_1.SlideShow(uiElements, new FixedUiElement_1.FixedUiElement("")).HideOnEmpty(true);
    return _this;
  }
...
},{"../UIElement":"UI/UIElement.ts","../../Logic/ImageSearcher":"Logic/ImageSearcher.ts","../SlideShow":"UI/SlideShow.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Base/VerticalCombine.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  VerticalCombine.prototype.InnerUpdate = function (htmlElement) {
    for (var _i = 0, _a = this._elements; _i < _a.length; _i++) {
      var element = _a[_i];
      element.Update();
    }
  ...
  VerticalCombine.prototype.Activate = function () {
    for (var _i = 0, _a = this._elements; _i < _a.length; _i++) {
      var element = _a[_i];
      element.Activate();
    }
...
},{"../UIElement":"UI/UIElement.ts"}],"Logic/TagsFilter.ts":[function(require,module,exports) {
"use strict";
...
},{}],"UI/Base/UIInputElement.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function (_super) {
  __extends(UIInputElement, _super);

  function UIInputElement() {
...
exports.UIInputElement = UIInputElement;
},{"../UIElement":"UI/UIElement.ts"}],"UI/Base/UIRadioButton.ts":[function(require,module,exports) {
"use strict";
...
exports.UIRadioButton = void 0;

var UIEventSource_1 = require("../UIEventSource");

var UIInputElement_1 = require("./UIInputElement");
...
function (_super) {
  ...
  function UIRadioButton(elements, valueMapping, selectFirstAsDefault) {
    ...
    _this.SelectedElementIndex = new UIEventSource_1.UIEventSource(null);
    _this._elements = elements;
    _this._selectFirstAsDefault = selectFirstAsDefault;
    var self = _this;
    _this._valueMapping = valueMapping;

    _this.SelectedElementIndex.addCallback(function () {
  ...
  UIRadioButton.prototype.IdFor = function (i) {
    return 'radio-' + this.id + '-' + i;
  };

  UIRadioButton.prototype.InnerRender = function () {
    var body = "";
    var i = 0;

    for (var _i = 0, _a = this._elements.data; _i < _a.length; _i++) {
      var el = _a[_i];
  ...
  UIRadioButton.prototype.InnerUpdate = function (htmlElement) {
    var self = this;

    function checkButtons() {
      for (var i = 0; i < self._elements.data.length; i++) {
    ...
    if (this.SelectedElementIndex.data == null) {
      if (this._selectFirstAsDefault) {
        var el_2 = document.getElementById(this.IdFor(0)); // @ts-ignore
      ...
      if (expected) {
        for (var i = 0; i < self._elements.data.length; i++) {
          var el_3 = document.getElementById(self.IdFor(i)); // @ts-ignore
        ...
        if (expected != checked) {
          var el_4 = document.getElementById(this.IdFor(expected)); // @ts-ignore
...
}(UIInputElement_1.UIInputElement);

exports.UIRadioButton = UIRadioButton;
},{"../UIEventSource":"UI/UIEventSource.ts","./UIInputElement":"UI/Base/UIInputElement.ts"}],"UI/SaveButton.ts":[function(require,module,exports) {
"use strict";
...
},{"./UIElement":"UI/UIElement.ts"}],"UI/Base/TextField.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function TextField(placeholder, mapping) {
  ...
  TextField.prototype.InnerRender = function () {
    ...
    return "<form onSubmit='return false' class='form-text-field'>" + "<input type='text' placeholder='" + ((_a = this._placeholder.data) !== null && _a !== void 0 ? _a : "") + "' id='text-" + this.id + "'>" + "</form>";
  };
...
},{"../UIEventSource":"UI/UIEventSource.ts","./UIInputElement":"UI/Base/UIInputElement.ts"}],"UI/Base/UIRadioButtonWithOther.ts":[function(require,module,exports) {
"use strict";
...
exports.UIRadioButtonWithOther = void 0;

var UIInputElement_1 = require("./UIInputElement");

var UIEventSource_1 = require("../UIEventSource");

var UIRadioButton_1 = require("./UIRadioButton");

var TextField_1 = require("./TextField");

var FixedUiElement_1 = require("./FixedUiElement");

var UIRadioButtonWithOther =
/** @class */
function (_super) {
  __extends(UIRadioButtonWithOther, _super);

  function UIRadioButtonWithOther(choices, otherChoiceTemplate, placeholder, choiceToValue, stringToValue) {
    var _this = _super.call(this, undefined) || this;

    _this._value = new UIEventSource_1.UIEventSource(undefined);
    var self = _this;
    _this._freeformText = new TextField_1.TextField(new UIEventSource_1.UIEventSource(placeholder), stringToValue);
    var otherChoiceElement = new FixedUiElement_1.FixedUiElement(otherChoiceTemplate.replace("$$$", _this._freeformText.Render()));
    choices.push(otherChoiceElement);
    _this._radioSelector = new UIRadioButton_1.UIRadioButton(new UIEventSource_1.UIEventSource(choices), function (i) {
      if (i === undefined || i === null) {
        return undefined;
      }

      if (i + 1 >= choices.length) {
        return _this._freeformText.GetValue().data;
      }

      return choiceToValue(i);
    }, false);

    _this._radioSelector.GetValue().addCallback(function (i) {
      self._value.setData(i);
    });

    _this._freeformText.GetValue().addCallback(function (str) {
      self._value.setData(str);
    });

    _this._freeformText.onClick(function () {
  ...
  UIRadioButtonWithOther.prototype.GetValue = function () {
    return this._value;
  };

  UIRadioButtonWithOther.prototype.InnerRender = function () {
    return this._radioSelector.Render();
  };

  UIRadioButtonWithOther.prototype.InnerUpdate = function (htmlElement) {
    _super.prototype.InnerUpdate.call(this, htmlElement);
  ...
  return UIRadioButtonWithOther;
}(UIInputElement_1.UIInputElement);

exports.UIRadioButtonWithOther = UIRadioButtonWithOther;
},{"./UIInputElement":"UI/Base/UIInputElement.ts","../UIEventSource":"UI/UIEventSource.ts","./UIRadioButton":"UI/Base/UIRadioButton.ts","./TextField":"UI/Base/TextField.ts","./FixedUiElement":"UI/Base/FixedUiElement.ts"}],"Customizations/TagRendering.ts":[function(require,module,exports) {
"use strict";
...
exports.TagRendering = exports.TagRenderingOptions = void 0;
...
var UIRadioButton_1 = require("../UI/Base/UIRadioButton");

var FixedUiElement_1 = require("../UI/Base/FixedUiElement");

var SaveButton_1 = require("../UI/SaveButton");

var TextField_1 = require("../UI/Base/TextField");

var UIRadioButtonWithOther_1 = require("../UI/Base/UIRadioButtonWithOther");
...
function () {
  ...
  TagRenderingOptions.prototype.IsQuestioning = function (tags) {
    ...
    for (var _i = 0, _a = this.options.mappings; _i < _a.length; _i++) {
...
function (_super) {
  ...
  function TagRendering(tags, changes, options) {
    ...
    var pickChoice = function pickChoice(i) {
      if (i === undefined || i === null) {
        return undefined;
      }
    ...
    var pickString = function pickString(string) {
      ...
      var tag = new TagsFilter_1.Tag(self._freeform.key, string);

      if (self._freeform.extraTags === undefined) {
        return tag;
      }

      return new TagsFilter_1.And([self._freeform.extraTags, tag]);
    }; // Prepare the actual input element -> pick an appropriate implementation


    var inputElement;

    if (_this._freeform !== undefined && _this._mapping !== undefined) {
      // Radio buttons with 'other'
      inputElement = new UIRadioButtonWithOther_1.UIRadioButtonWithOther(choices, _this._freeform.template, _this._freeform.placeholder, pickChoice, pickString);
      _this._questionElement = inputElement;
    } else if (_this._mapping !== undefined) {
      // This is a classic radio selection element
      inputElement = new UIRadioButton_1.UIRadioButton(new UIEventSource_1.UIEventSource(choices), pickChoice);
      _this._questionElement = inputElement;
    } else if (_this._freeform !== undefined) {
      _this._textField = new TextField_1.TextField(new UIEventSource_1.UIEventSource(_this._freeform.placeholder), pickString);
      inputElement = _this._textField;
      _this._questionElement = new FixedUiElement_1.FixedUiElement(_this._freeform.template.replace("$$$", inputElement.Render()));
    } else {
      throw "Invalid questionRendering, expected at least choices or a freeform";
    }

    var save = function save() {
      var selection = inputElement.GetValue().data;
    ...
    _this._saveButton = new SaveButton_1.SaveButton(inputElement.GetValue()).onClick(save);
    ...
    if (_this._question !== undefined) {
      _this._editButton = new FixedUiElement_1.FixedUiElement("<img class='editbutton' src='./assets/pencil.svg' alt='edit'>").onClick(function () {
        ...
        if (self._textField) {
          self._textField.value.setData((_a = self._source.data["name"]) !== null && _a !== void 0 ? _a : "");
        }
  ...
  TagRendering.prototype.InnerRender = function () {
    if (this.IsQuestioning() || this._editMode.data) {
      ...
      return "<div class='question'>" + this._question + (this._question !== "" ? "<br/>" : "") + this._questionElement.Render() + this._skipButton.Render() + this._saveButton.Render() + "</div>";
    }
    ...
    if (this.IsKnown()) {
      ...
      return "<span class='answer'>" + "<span class='answer-text'>" + html + "</span>" + this._editButton.Render() + "</span>";
    }
  ...
  TagRendering.prototype.InnerUpdate = function (htmlElement) {
    ...
    (_a = this._textField) === null || _a === void 0 ? void 0 : _a.Update();
...
exports.TagRendering = TagRendering;
},{"../UI/UIElement":"UI/UIElement.ts","../UI/UIEventSource":"UI/UIEventSource.ts","../Logic/TagsFilter":"Logic/TagsFilter.ts","../UI/Base/UIRadioButton":"UI/Base/UIRadioButton.ts","../UI/Base/FixedUiElement":"UI/Base/FixedUiElement.ts","../UI/SaveButton":"UI/SaveButton.ts","../UI/Base/TextField":"UI/Base/TextField.ts","../UI/Base/UIRadioButtonWithOther":"UI/Base/UIRadioButtonWithOther.ts","../UI/Base/VariableUIElement":"UI/Base/VariableUIElement.ts"}],"UI/Img.ts":[function(require,module,exports) {
"use strict";
...
var ImageCarousel_1 = require("./Image/ImageCarousel");
...
function (_super) {
  ...
  function FeatureInfoBox(tagsES, title, elementsToShow, changes, userDetails, preferedPictureLicense) {
    ...
    _this._imageElement = new ImageCarousel_1.ImageCarousel(_this._tagsES);
    _this._infoboxes = [];
    ...
    for (var _i = 0, elementsToShow_1 = elementsToShow; _i < elementsToShow_1.length; _i++) {
      ...
      _this._infoboxes.push(new TagRendering_1.TagRendering(_this._tagsES, _this._changes, tagRenderingOption.options));
    }
    ...
    _this._title = new TagRendering_1.TagRendering(_this._tagsES, _this._changes, title.options);
    _this._osmLink = new TagRendering_1.TagRendering(_this._tagsES, _this._changes, new OsmLink_1.OsmLink().options);
    _this._wikipedialink = new TagRendering_1.TagRendering(_this._tagsES, _this._changes, new WikipediaLink_1.WikipediaLink().options);
    _this._pictureUploader = new OsmImageUploadHandler_1.OsmImageUploadHandler(tagsES, userDetails, preferedPictureLicense, changes, _this._imageElement.slideshow).getUI();
    return _this;
  }
  ...
  FeatureInfoBox.prototype.InnerRender = function () {
    ...
    return "<div class='featureinfobox'>" + "<div class='featureinfoboxtitle'>" + "<span>" + this._title.Render() + "</span>" + this._wikipedialink.Render() + this._osmLink.Render() + "</div>" + "<div class='infoboxcontents'>" + this._imageElement.Render() + this._pictureUploader.Render() + new VerticalCombine_1.VerticalCombine(info, "infobox-information ").Render() + questionsHtml + "</div>" + "" + "</div>";
  };

  FeatureInfoBox.prototype.Activate = function () {
    _super.prototype.Activate.call(this);
  ...
  FeatureInfoBox.prototype.Update = function () {
...
},{"./UIElement":"UI/UIElement.ts","../Logic/OsmImageUploadHandler":"Logic/OsmImageUploadHandler.ts","./Image/ImageCarousel":"UI/Image/ImageCarousel.ts","./Base/VerticalCombine":"UI/Base/VerticalCombine.ts","../Customizations/TagRendering":"Customizations/TagRendering.ts","../Customizations/Questions/OsmLink":"Customizations/Questions/OsmLink.ts","../Customizations/Questions/WikipediaLink":"Customizations/Questions/WikipediaLink.ts","../Logic/TagsFilter":"Logic/TagsFilter.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
