...
},{"../UIElement":"UI/UIElement.ts"}],"UI/ConfirmDialog.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function ConfirmDialog(show, question, optionA, optionB, executeA, executeB, classA, classB) {
    ...
    _this._question = new FixedUiElement_1.FixedUiElement("<span class='ui-question'>" + question + "</span>").onClick(function () {
      self._showOptions.setData(!self._showOptions.data);
    });
    _this._optionA = new VariableUIElement_1.VariableUiElement(_this._showOptions.map(function (show) {
      return show ? "<div class='" + classA + "'>" + optionA + "</div>" : "";
    })).onClick(function () {
      self._showOptions.setData(false);
  ...
  ConfirmDialog.prototype.InnerRender = function () {
    ...
    return this._question.Render() + this._optionA.Render() + this._optionB.Render();
  };
...
},{"./UIElement":"UI/UIElement.ts","./UIEventSource":"UI/UIEventSource.ts","./Base/FixedUiElement":"UI/Base/FixedUiElement.ts","./Base/VariableUIElement":"UI/Base/VariableUIElement.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/ConfirmDialog.ts"], null)
//# sourceMappingURL=/UI/ConfirmDialog.js.map