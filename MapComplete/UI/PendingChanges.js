...
},{}],"UI/PendingChanges.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function PendingChanges(pendingChangesCount, countdown, isSaving) {
    var _this = _super.call(this, pendingChangesCount) || this;

    _this.ListenTo(isSaving);

    _this.ListenTo(countdown);

    _this._pendingChangesCount = pendingChangesCount;
    _this._countdown = countdown;
    _this._isSaving = isSaving;
    return _this;
  }
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/PendingChanges.ts"], null)
//# sourceMappingURL=/UI/PendingChanges.js.map