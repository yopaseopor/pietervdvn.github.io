...
function () {
  function TagMappingOptions(options) {
    ...
    this.allowDelete = (_a = options.allowDelete) !== null && _a !== void 0 ? _a : false;
  }
...
function (_super) {
  ...
  TagMapping.prototype.InnerRender = function () {
    var attrRender = this.RenderAttribute();
  ...
  TagMapping.prototype.RenderAttribute = function () {
    var o = this.options;
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/TagMapping.ts"], null)
//# sourceMappingURL=/UI/TagMapping.js.map