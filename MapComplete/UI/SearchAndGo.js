...
},{}],"UI/Input/InputElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UI/UIEventSource":"UI/UIEventSource.ts"}],"UI/Input/DropDown.ts":[function(require,module,exports) {
"use strict";
...
},{"./Translation":"UI/i18n/Translation.ts","../UIElement":"UI/UIElement.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Input/TextField.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIEventSource":"UI/UIEventSource.ts","./InputElement":"UI/Input/InputElement.ts","../i18n/Translations":"UI/i18n/Translations.ts"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"node_modules/process/browser.js"}],"Logic/Geocoding.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Geocoding.Search = function (query, basemap, handleResult, onFail) {
    ...
    console.log(b);
    $.getJSON(Geocoding.host + "format=json&limit=1&viewbox=" + (b.getEast() + "," + b.getNorth() + "," + b.getWest() + "," + b.getSouth()) + "&accept-language=nl&q=" + query, function (data) {
      handleResult(data);
    }).fail(function () {
      onFail();
    });
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"UI/Base/VariableUIElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/SearchAndGo.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function SearchAndGo(map) {
    ...
    _this._placeholder = new UIEventSource_1.UIEventSource(Translations_1.default.t.general.search.search);
    _this._searchField = new TextField_1.TextField({
      placeholder: new VariableUIElement_1.VariableUiElement(_this._placeholder.map(function (uiElement) {
        return uiElement.InnerRender();
  ...
  SearchAndGo.prototype.RunSearch = function () {
    ...
    this._placeholder.setData(Translations_1.default.t.general.search.searching);

    var self = this;
    Geocoding_1.Geocoding.Search(searchString, this._map, function (result) {
      if (result.length == 0) {
        _this._placeholder.setData(Translations_1.default.t.general.search.nothing);

        return;
      }

      var bb = result[0].boundingbox;
      var bounds = [[bb[0], bb[2]], [bb[1], bb[3]]];

      self._map.map.fitBounds(bounds);

      _this._placeholder.setData(Translations_1.default.t.general.search.search);
    }, function () {
      _this._placeholder.setData(Translations_1.default.t.general.search.error);
    });
  };

  SearchAndGo.prototype.InnerRender = function () {
    return this._searchField.Render() + this._goButton.Render();
  };
...
},{"./UIElement":"UI/UIElement.ts","./Input/TextField":"UI/Input/TextField.ts","./UIEventSource":"UI/UIEventSource.ts","./Base/FixedUiElement":"UI/Base/FixedUiElement.ts","../Logic/Geocoding":"Logic/Geocoding.ts","./Base/VariableUIElement":"UI/Base/VariableUIElement.ts","./i18n/Locale":"UI/i18n/Locale.ts","./i18n/Translations":"UI/i18n/Translations.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","UI/SearchAndGo.ts"], null)
//# sourceMappingURL=/UI/SearchAndGo.js.map