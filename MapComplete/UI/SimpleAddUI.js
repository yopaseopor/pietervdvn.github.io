...
},{"../../Logic/LocalStorageSource":"Logic/LocalStorageSource.ts","../Input/DropDown":"UI/Input/DropDown.ts"}],"UI/Base/Button.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function Button(text, onclick, clss) {
    ...
    _this._text = Translations_1.default.W(text);
...
},{"../UIElement":"UI/UIElement.ts","../i18n/Locale":"UI/i18n/Locale.ts","../i18n/Translations":"UI/i18n/Translations.ts"}],"UI/SimpleAddUI.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  function SimpleAddUI(zoomlevel, lastClickLocation, changes, selectedElement, dataIsLoading, userDetails, addButtons) {
    ...
    for (var _i = 0, addButtons_1 = addButtons; _i < addButtons_1.length; _i++) {
      ...
      var button = new Button_1.Button(Translations_1.default.t.general.add.addNew.Subs({
        category: option.name
      }), _this.CreatePoint(option));
  ...
  SimpleAddUI.prototype.InnerRender = function () {
    var header = Translations_1.default.t.general.add.header;

    if (!this._userDetails.data.loggedIn) {
      return new Combine_1.default([header, Translations_1.default.t.general.add.pleaseLogin]).Render();
    }

    if (this._zoomlevel.data.zoom < 19) {
      return new Combine_1.default([header, Translations_1.default.t.general.add.zoomInFurther]).Render();
    }

    if (this._dataIsLoading.data) {
      return new Combine_1.default([header, Translations_1.default.t.general.add.stillLoading]).Render();
    }
...
},{"./UIElement":"UI/UIElement.ts","./Base/Button":"UI/Base/Button.ts","./i18n/Translations":"UI/i18n/Translations.ts","./Base/Combine":"UI/Base/Combine.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
