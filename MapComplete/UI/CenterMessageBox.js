...
},{"./Translation":"UI/i18n/Translation.ts","../UIElement":"UI/UIElement.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/CenterMessageBox.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  CenterMessageBox.prototype.InnerRender = function () {
    ...
    if (this._queryRunning.data) {
      return Translations_1.default.t.centerMessage.loadingData.Render();
    } else if (this._zoomInMore.data) {
      return Translations_1.default.t.centerMessage.zoomIn.Render();
    }

    return Translations_1.default.t.centerMessage.ready.Render();
  };
...
},{"./UIElement":"UI/UIElement.ts","./UIEventSource":"UI/UIEventSource.ts","./i18n/Translations":"UI/i18n/Translations.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
