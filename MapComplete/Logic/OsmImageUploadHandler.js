...
},{"process":"node_modules/process/browser.js"}],"Logic/Wikimedia.ts":[function(require,module,exports) {
"use strict";
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"Logic/Imgur.ts":[function(require,module,exports) {
"use strict";
...
exports.Imgur = Imgur;
},{"jquery":"node_modules/jquery/dist/jquery.js","./Wikimedia":"Logic/Wikimedia.ts"}],"UI/Input/InputElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UI/UIEventSource":"UI/UIEventSource.ts"}],"UI/i18n/Locale.ts":[function(require,module,exports) {
"use strict";
...
},{"./Translation":"UI/i18n/Translation.ts","../UIElement":"UI/UIElement.ts","../Base/FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Input/DropDown.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIEventSource":"UI/UIEventSource.ts","./InputElement":"UI/Input/InputElement.ts","../i18n/Translations":"UI/i18n/Translations.ts"}],"UI/ImageUploadFlow.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  ImageUploadFlow.prototype.InnerRender = function () {
    if (!this._userdetails.data.loggedIn) {
      return "<div class='activate-osm-authentication'>" + Translations_1.default.t.image.pleaseLogin.Render() + "</div>";
    }

    var uploadingMessage = "";

    if (this._isUploading.data == 1) {
      return "<b>" + Translations_1.default.t.image.uploadingPicture.Render() + "</b>";
    }
...
},{"./UIElement":"UI/UIElement.ts","./UIEventSource":"UI/UIEventSource.ts","jquery":"node_modules/jquery/dist/jquery.js","../Logic/Imgur":"Logic/Imgur.ts","./Input/DropDown":"UI/Input/DropDown.ts","./i18n/Translations":"UI/i18n/Translations.ts"}],"Logic/OsmImageUploadHandler.ts":[function(require,module,exports) {
"use strict";
