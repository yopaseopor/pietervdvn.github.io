...
/** @class */
function () {
  function Changes(changesetComment, login, allElements, centerMessage) {
  ...
  Changes.prototype.addChange = function (elementId, key, value) {
    if (!this.login.userDetails.data.loggedIn) {
      this._centerMessage.setData("<p>Bedankt voor je antwoord!</p>" + "<p>Gelieve <span class='activate-osm-authentication'>in te loggen op OpenStreetMap</span> om dit op te slaan.</p>" + "<p>Nog geen account? <a href=\'https://www.openstreetmap.org/user/new\' target=\'_blank\'>Registreer hier</a></p>");

      var self_1 = this;
      this.login.userDetails.addCallback(function () {
        if (self_1.login.userDetails.data.loggedIn) {
          self_1._centerMessage.setData("");
        }
      });
      return;
    }
