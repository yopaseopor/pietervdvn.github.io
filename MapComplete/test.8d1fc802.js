...
},{"process":"node_modules/process/browser.js"}],"Logic/OsmObject.ts":[function(require,module,exports) {
"use strict";
...
},{"jquery":"node_modules/jquery/dist/jquery.js"}],"UI/UIElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UI/UIElement":"UI/UIElement.ts"}],"Logic/TagsFilter.ts":[function(require,module,exports) {
"use strict";
...
},{}],"Logic/Changes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Changes.prototype.addChange = function (elementId, key, value) {
    ...
    eventSource.ping(); // We get the id from the event source, as that ID might be rewritten

    this._pendingChanges.push({
      elementId: eventSource.data.id,
      key: key,
      value: value
    });
  ...
  Changes.prototype.createElement = function (basicTags, lat, lon) {
    ...
    this._allElements.addOrGetElement(geojson); // The basictags are COPIED, the id is included in the properties
  ...
  Changes.prototype.uploadAll = function (optionalContinuation) {
    ...
    var optionalContinuationWrapped = function optionalContinuationWrapped() {
    ...
    DownloadAndContinue(neededIds, function () {
      ...
      for (var _i = 0, pending_2 = pending; _i < pending_2.length; _i++) {
        ...
        if (parseInt(change.elementId.split("/")[1]) < 0) {
          ...
          knownElements[change.elementId].addTag(change.key, change.value); // note: addTag will flag changes with 'element.changed' internally
        }
      ...
      var handleMapping = function handleMapping(idMapping) {
      ...
      self.login.UploadChangeset(self._changesetComment, function (csId) {
        ...
        var changes = "<osmChange version='0.6' generator='Mapcomplete 0.0.0'>";
        ...
        if (modifications.length > 0) {
          changes += "<modify>" + modifications + "</modify>";
        }
  ...
  Changes.prototype.asQuestions = function (qs) {
    ...
    for (var i in qs) {
      ls.push(new Question_1.Question(this, qs[i]));
    }
...
},{"./OsmObject":"Logic/OsmObject.ts","../UI/UIEventSource":"UI/UIEventSource.ts","./Question":"Logic/Question.ts","./TagsFilter":"Logic/TagsFilter.ts"}],"node_modules/jshashes/hashes.js":[function(require,module,exports) {
var global = arguments[3];
var define;
/**
...
},{"ohauth":"node_modules/ohauth/index.js","resolve-url":"node_modules/resolve-url/resolve-url.js","store":"node_modules/store/dist/store.legacy.js","xtend":"node_modules/xtend/immutable.js"}],"Logic/OsmConnection.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  OsmConnection.prototype.AttemptLogin = function () {
    ...
    this.auth.xhr({
      ...
      self.UpdatePreferences(); // details is an XML DOM of user details
  ...
  OsmConnection.prototype.registerActivateOsmAUthenticationClass = function () {
    ...
    for (var i = 0; i < authElements.length; i++) {
      var element = authElements.item(i); // @ts-ignore
  ...
  OsmConnection.prototype.OpenChangeset = function (comment, continuation) {
    this.auth.xhr({
      ...
      content: '<osm><changeset>' + '<tag k="created_by" v="MapComplete 0.0.0" />' + '<tag k="comment" v="' + comment + '"/>' + '</changeset></osm>'
...
},{"osm-auth":"node_modules/osm-auth/index.js","../UI/UIEventSource":"UI/UIEventSource.ts"}],"Logic/ElementStorage.ts":[function(require,module,exports) {
"use strict";
...
},{"../UI/UIEventSource":"UI/UIEventSource.ts"}],"UI/Base/UIInputElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIEventSource":"UI/UIEventSource.ts","./UIInputElement":"UI/Base/UIInputElement.ts"}],"UI/Base/FixedUiElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"UI/SaveButton.ts":[function(require,module,exports) {
"use strict";
...
},{"./UIInputElement":"UI/Base/UIInputElement.ts","../UIEventSource":"UI/UIEventSource.ts","./UIRadioButton":"UI/Base/UIRadioButton.ts","./TextField":"UI/Base/TextField.ts","./FixedUiElement":"UI/Base/FixedUiElement.ts"}],"UI/Base/VariableUIElement.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIElement":"UI/UIElement.ts"}],"Customizations/TagRendering.ts":[function(require,module,exports) {
"use strict";
...
},{"../TagRendering":"Customizations/TagRendering.ts","../../UI/Img":"UI/Img.ts","../../Logic/TagsFilter":"Logic/TagsFilter.ts"}],"test.ts":[function(require,module,exports) {
"use strict";
...
var tagsES = new UIEventSource_1.UIEventSource(tags);
var login = new OsmConnection_1.OsmConnection(true);
var allElements = new ElementStorage_1.ElementStorage();
allElements.addElementById(tags.id, tagsES);
var changes = new Changes_1.Changes("Test", login, allElements);
new OsmLink_1.OsmLink(tagsES, changes).AttachTo("maindiv");
},{"./UI/UIEventSource":"UI/UIEventSource.ts","./Logic/Changes":"Logic/Changes.ts","./Logic/OsmConnection":"Logic/OsmConnection.ts","./Logic/ElementStorage":"Logic/ElementStorage.ts","./Customizations/Questions/OsmLink":"Customizations/Questions/OsmLink.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
