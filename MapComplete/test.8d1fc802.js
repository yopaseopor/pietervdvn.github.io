...
},{}],"UI/Base/TextField.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  TextField.prototype.InnerRender = function () {
    return "<form onSubmit='return false' class='form-text-field'>" + "<input type='text' placeholder='" + this._placeholder.data + "' id='text-" + this.id + "'>" + "</form>";
  };
...
function () {
  ...
  Geocoding.Search = function (query, currentLocation, handleResult) {
    $.getJSON(Geocoding.host + "format=json&accept-language=nl&q=" + query, function (data) {
      handleResult(data);
    });
  };
...
function (_super) {
  ...
  function SearchAndGo(map) {
    ...
    _this._placeholder = new UIEventSource_1.UIEventSource("Ga naar een locatie...");
...
},{"./UIElement":"UI/UIElement.ts","./Base/TextField":"UI/Base/TextField.ts","./UIEventSource":"UI/UIEventSource.ts","./Base/FixedUiElement":"UI/Base/FixedUiElement.ts","../Logic/Geocoding":"Logic/Geocoding.ts"}],"test.ts":[function(require,module,exports) {
"use strict";
...
console.log("HI");
new SearchAndGo_1.SearchAndGo().AttachTo("maindiv");
...
/*/
//*/
},{"./UI/SearchAndGo":"UI/SearchAndGo.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
