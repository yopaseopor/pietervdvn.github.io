...
},{}],"UI/Base/DropDownUI.ts":[function(require,module,exports) {
"use strict";
...
},{"../UIEventSource":"UI/UIEventSource.ts","../UIElement":"UI/UIElement.ts"}],"test.ts":[function(require,module,exports) {
"use strict";
...
var DropDownUI_1 = require("./UI/Base/DropDownUI");

var UIEventSource_1 = require("./UI/UIEventSource");

console.log("HI");
var control = new UIEventSource_1.UIEventSource("b");
control.addCallback(function (data) {
  console.log("> GOT", control.data);
});
new DropDownUI_1.DropDownUI("Test", [{
  value: "a",
  shown: "a"
}, {
  value: "b",
  ...
  value: "c",
  shown: "c"
}], control).AttachTo("maindiv");
new VariableUIElement_1.VariableUiElement(control).AttachTo("extradiv");
window.setTimeout(function () {
  control.setData("a");
}, 1000);
},{"./UI/Base/VariableUIElement":"UI/Base/VariableUIElement.ts","./UI/Base/DropDownUI":"UI/Base/DropDownUI.ts","./UI/UIEventSource":"UI/UIEventSource.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
